CREATE TABLE hero_stats (
    ...
    UNIQUE(hero, region, platform, role, gamemode, map, tier, timestamp)
);
...
CREATE INDEX idx_hero_stats_lookup ON hero_stats(hero, region, platform, gamemode, map, tier, timestamp);
